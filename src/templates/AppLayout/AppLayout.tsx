...
const navItems: NavItem[] = [
  { label: 'Dashboard', path: APP_ROUTES.DASHBOARD, icon: <DashboardIcon /> },
  { label: 'Users', path: APP_ROUTES.USERS, icon: <PeopleIcon /> },
  { label: 'Posts', path: APP_ROUTES.POSTS, icon: <ArticleIcon /> },
]
...
const AppLayout: React.FC<AppLayoutProps> = ({ children }) => {
  ...
  const isActiveRoute = (path: string) => {
    if (path === APP_ROUTES.DASHBOARD) return location.pathname === path
