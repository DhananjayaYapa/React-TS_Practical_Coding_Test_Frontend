  ...
  components: {
    ...
    MuiButton: {
      styleOverrides: {
        ...
        contained: {
          boxShadow: 'none',
          '&:hover': { boxShadow: `0 4px 12px ${alpha(primaryGreen, 0.4)}` },
        },
      },
    },
    MuiCard: {
      ...
      styleOverrides: {
        root: {
          '& .MuiOutlinedInput-root': {
            ...
            '&.Mui-focused .MuiOutlinedInput-notchedOutline': { borderColor: primaryGreen },
          },
        },
      },
    },
    ...
    MuiTableCell: {
      styleOverrides: {
        root: { borderBottom: `1px solid ${alpha('#ffffff', 0.08)}` },
        head: { fontWeight: 600, backgroundColor: alpha(surfaceBackground, 0.8) },
      },
    },
    MuiAlert: {
